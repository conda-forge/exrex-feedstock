...
Once the `conda-forge` channel has been enabled, `exrex` can be installed with:

```
conda install exrex
```

It is possible to list all of the versions of `exrex` available on your platform with:
